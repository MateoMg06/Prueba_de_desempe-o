...
export function ticketTr(ticket) {
  return `<tr>
              ...
              <td>
                <div class="ticket-title">${ticket.workspace}</div>
                <div class="ticket-cat">${ticket.reason}</div>
              </td>
              <td>
                <div class="requester">
              ...
              <td>
                <div class="tech-wrap">
                  <img src="../img/perfil.png" alt="">
                  <span class="badge badge-green">${ticket.startHour}</span>
                </div>
              </td>
              <td><span class="badge badge-red">${ticket.endHour}</span></td>
