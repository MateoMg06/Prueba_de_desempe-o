...
export function ticketCard(ticket) {
    ...
    const isClosed = ticket.status == "Denied" || ticket.status == "cerrado" || ticket.status == "Accepted" || ticket.status == "Solucionado";
    ...
    return `<article class="ticket-card">
            <header class="card-header">
                <span class="tag tag-red">Status: ${ticket.status}</span>
                <span class="priority priority-urgent">Workspace: ${ticket.workspace}</span>
            </header>
            ...
            <address class="requester">
                ...
                <p>
                <strong class="req-name">${ticket.reason}</strong>
                </p>
            </address>
